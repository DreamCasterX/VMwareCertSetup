...
class SUTConfigurator(BaseConfigurator):
    def __init__(self):
        ...
        self.default_gateway = "192.168.10.10"
        self.default_dns = "192.168.10.10"
...
class VCConfigurator(BaseConfigurator):
    def __init__(self):
        ...
        self.default_TC_host = "10.244.17.21"
        self.default_TC_password = "Passw0rd!"   
        self.default_VC_prefix = "24"
        self.default_VC_gateway = "192.168.10.10"
        self.default_VC_dns_servers = "192.168.10.10"
        ...
        self.default_VC_ntp_servers = "192.168.10.10"
...
class DNSConfigurator(BaseConfigurator):
    def __init__(self):
        super().__init__()
        self.default_dns_server = "192.168.10.10"  # 預設 DNS 伺服器 IP
