...
from main_BDC import SUTConfigurator, VIVaConfigurator, AgentConfigurator, VCConfigurator, OVFManager, DNSConfigurator, ResultLogCopier
import pandas as pd
import os
import json
import subprocess
            ...
            **Prerequisites**
            ...
            with form_col:
                with st.form("viva_form"):
                    ...
                    external_dns = st.text_input("External DNS IP", value="10.96.1.18")
                    submitted = st.form_submit_button("Start Configuration", type="primary")
            if submitted:
