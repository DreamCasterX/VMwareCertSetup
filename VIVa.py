...
def update_jump_server_hosts_file(internal_ip: str) -> bool:
...
def main():
    ...
    r"""
 =====================================
 VMware VIVa Auto Configuration Tool 
                 v1.1 
 =====================================
"""
)
        ...
        if check_internet(ssh_client):
            ...
            if stdout.channel.recv_exit_status() == 0:
                ...
                if success and new_ssh_client:
                    ...
                    # 更新本機hosts檔案
                    if update_jump_server_hosts_file(internal_ip):
                        # 顯示成功完成訊息
